...
static irqreturn_t e1000_intr_msi(int __always_unused irq, void *data)
{
	...
	if (icr & E1000_ICR_LSC) {
                pr_info("e1000_intr_msi: E1000_ICR_LSC triggered\n");
...
static irqreturn_t e1000_intr(int __always_unused irq, void *data)
{
	...
	if (icr & E1000_ICR_LSC) {
                pr_info("e1000_intr: E1000_ICR_LSC triggered\n");
		hw->mac.get_link_status = true;
		/* ICH8 workaround-- Call gig speed drop workaround on cable
		 * disconnect (LSC) before accessing any PHY registers
		 */
...
static irqreturn_t e1000_msix_other(int __always_unused irq, void *data)
{
	...
	struct e1000_hw *hw = &adapter->hw;
        ...
        pr_info("e1000_msix_other: should not be here?\n");
	hw->mac.get_link_status = true;
...
static bool e1000e_has_link(struct e1000_adapter *adapter)
{
	...
	case e1000_media_type_copper:
		if (hw->mac.get_link_status) {
                        pr_info("e1000e_has_link: get_link_status triggered\n");
...
void ec_poll(struct net_device *netdev)
{
	...
	if (jiffies - adapter->ec_watchdog_jiffies >= 2 * HZ) {
		struct e1000_hw *hw = &adapter->hw;
		hw->mac.get_link_status = true;
                pr_info("ec_poll: jiffies timeout\n");
